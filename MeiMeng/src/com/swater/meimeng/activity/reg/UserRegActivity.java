...
public class UserRegActivity extends BaseTemplate {
	...
	void iniAssertRange() {
		...
		// http://192.168.31.4:112/api/user/register/city_id/1/realname/dgggh/password/510950/telephone/15982057958/assets_level/4/age/29/sex/1
		// 1-(500W以下)；
		// 2-(500W-1000W)；
		// 3-(1000W-3000W)；
		// 4-(3000W-5000W)；
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.womanman_reg_by_phone);
		this.TempRun();
	...
	public void iniView() {
		...
		// switch (tag_which) {
		/**
		 * case 1:// 女 { view_Show(findButton(R.id.home_right_btn));
		 ...
		 * view_Show(findViewById(R.id.isextra_female_hide));
		 * view_Hide(findViewById(R.id.isextra_lay_male_hide)); //
		 * setValueToView(findViewById(R.id.txt_assert), "年龄"); } break; case
		 * 2:// 男 {
		 */
		// setValueToView(findViewById(R.id.txt_assert), "资产");
		view_Show(findViewById(R.id.home_left_btn));
		setValueToView(findViewById(R.id.home_left_btn), "返回");
	...
	void regUser() {
		...
		req_map_param.put(MConstantUser.UserReg.realname,
				getValueView(findViewById(R.id.txt_input_name)));

		req_map_param.put(MConstantUser.UserReg.age,
				getValueView(findViewById(R.id.txt_reg_age)));
		req_map_param.put(MConstantUser.UserReg.sex, "2");
		// req_map_param.put(MConstantUser.UserReg.assets_level, assets_level);
		// }
		// break;
		// case 2:// 男
		// {
		//
		// req_map_param.put(MConstantUser.UserReg.realname,
		// getValueView(findViewById(R.id.input_name_man)));
		// req_map_param.put(MConstantUser.UserReg.sex, "1");
		// req_map_param.put(MConstantUser.UserReg.age,
		// getValueView(findViewById(R.id.txt_reg_age_man)));
		// }
		// break;
		//
		// default:
