...
package com.swater.meimeng.mutils.wheelview;
...
public class WheelView extends View {
	...
	/** Items text color */
	private static final int ITEMS_TEXT_COLOR = 0xFF888888;
	...
	/** Text size */
	private static int TEXT_SIZE = 15;// 15
	...
	private static final int DEF_VISIBLE_ITEMS = 11;
	...
	private void initData(Context context) {
		...
		Log.e("手机屏幕的密度Dpi=：",""+dm.densityDpi+";手机屏幕的密度："+dm.density+";手机屏幕的分辨率："+dm.widthPixels);

//		if (dm.density * 160 <= 160) {
//			Log.d(this.getClass().getSimpleName(),
//					"mmmmmmmmmmmmmmmmmmmmmmmmmm density");
//			TEXT_SIZE = 30;
//		} else if (dm.density * 160 <= 240) {
//			Log.d(this.getClass().getSimpleName(),
//					"hhhhhhhhhhhhhhhhhhhhhhhhhh density");
//			TEXT_SIZE = 40;
//		} else {
//			Log.d(this.getClass().getSimpleName(),
//					"xxxxxxxxxxxxxxxxxxxxxxxxxx density");
//			TEXT_SIZE = 50;
//		}
...
//			TODO
	...
	protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		setMeasuredDimension(width, height);// 告诉父类，我有多宽，多高。
	}
	...
	protected void onDraw(Canvas canvas) {
		...
		if (itemsWidth > 0) {
			...
			drawItems(canvas);// 其它未选中的值
			drawValue(canvas);// 选中的值
			canvas.restore();
		}

		drawCenterRect(canvas);// 中间选中区域。
		//drawShadows(canvas);// 加阴影效果
	}
