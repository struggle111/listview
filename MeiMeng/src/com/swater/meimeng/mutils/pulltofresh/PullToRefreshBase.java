package com.swater.meimeng.mutils.pulltofresh;
...
import com.swater.meimeng.mutils.pulltofresh.libs.LoadingLayout;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout {
	...
	private void init(Context context, AttributeSet attrs) {
		...
		String releaseLabel;
		String type = attrs.getAttributeValue(null, "refresh_type");
		if ("totalMatchList".equals(type)) {
			pullLabel = context
					.getString(R.string.pull_to_refresh_pull_label_total_against);
			refreshingLabel = context
					.getString(R.string.pull_to_refresh_refreshing_label);
			releaseLabel = context
					.getString(R.string.pull_to_refresh_release_label_total_against);
		} else {
