...
import com.swater.meimeng.mutils.OMdown.UserTask.TaskCallback;
...
public abstract class UserTask<Params, Progress, Result> {
	 ...
	 * @param params
	 *            The parameters of the task.
	 * @return This instance of UserTask. {@link UserTask.Status#RUNNING} or
...
class Main1Activity extends Activity {
	@Override
	...
	private void handlePrinter() {
		MyTaskImgDown task_im = new MyTaskImgDown(this);
		task_im.registerCallback(new TaskCallback<Object, Object, Bitmap>() {

			@Override
			public Bitmap call(UserTask<Object, Object, Bitmap> task,
		...
		task.registerCallback(new TaskCallback<Integer, Void, Integer>() {
			@Override
			public Integer call(UserTask<Integer, Void, Integer> task,
	...
	private class PrinterTask11 extends UserTask<Object, Object, Bitmap> {

		public PrinterTask11(Context context) {
			super(context);
		}
